            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="arcade-chip min-w-[7.75rem] justify-between">
                  <span className="text-lg">рџЄ™</span>
                ...
                {user ? (
                  ...
                  <div className="arcade-chip min-w-[7.75rem] justify-between">
                    <span className="text-lg">вљ™</span>
            ...
            <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              {profile && hero && levelProgress ? (
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between gap-3">
                      <p className="text-sm font-semibold text-white">
                        {profile.title} вЂў Lv. {profile.level}
                      </p>
                ...
                <div className="rounded-[1.5rem] border border-dashed border-white/16 px-4 py-3 text-sm text-white/72">
                  Р’С‹Р±РµСЂРё РєР»Р°СЃСЃ, С‡С‚РѕР±С‹ РѕС‚РєСЂС‹С‚СЊ СЃРІРѕР№ arcade-РїСѓС‚СЊ.
                </div>
              )}
            </div>
          </header>
