      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-white/68 sm:text-base">
              В этом режиме room code живёт только здесь: создай матч, отправь invite
              и переходи в live board.
            </p>
          </div>
        ...
        {!isAuthenticated ? (
          <div className="mt-10 rounded-[2.4rem] border border-white/12 bg-[linear-gradient(180deg,rgba(20,26,34,0.9),rgba(12,14,22,0.96))] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.34)] sm:p-8">
            ...
            <h2 className="mt-4 font-display text-3xl text-white">Sign in to duel live</h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-white/68">
              Friend rooms use cloud auth, shared state and realtime updates. One tap,
              then you are back here with room controls unlocked.
            </p>
            <Link
          ...
          <div className="mt-10 rounded-[2.4rem] border border-white/12 bg-[linear-gradient(180deg,rgba(20,26,34,0.9),rgba(12,14,22,0.96))] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.34)] sm:p-8">
            <h2 className="font-display text-3xl text-white">Choose your class first</h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-white/68">
              The friend duel borrows your active hero identity, so finish class setup
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-[1fr_0.92fr]">
            <article className="rounded-[2.5rem] border border-white/12 bg-[linear-gradient(180deg,rgba(12,56,56,0.88),rgba(12,18,28,0.96))] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.34)] sm:p-7">
              ...
              <p className="mt-3 text-sm leading-7 text-white/68">
                Получишь свежий код, invite link и waiting surface, пока друг не войдёт.
              </p>
              ...
              >
                {isCreating ? 'Creating...' : 'Создать комнату'}
              </button>
            </article>
            ...
            <article className="rounded-[2.5rem] border border-white/12 bg-[linear-gradient(180deg,rgba(26,30,42,0.92),rgba(12,14,22,0.96))] p-6 shadow-[0_28px_80px_rgba(0,0,0,0.34)] sm:p-7">
              ...
              <p className="mt-3 text-sm leading-7 text-white/68">
                Вставь код от друга и сразу переходи в общий live board.
              </p>
              ...
              >
                {isJoining ? 'Opening...' : 'Войти в комнату'}
              </button>
            </article>
          </div>
        )}
